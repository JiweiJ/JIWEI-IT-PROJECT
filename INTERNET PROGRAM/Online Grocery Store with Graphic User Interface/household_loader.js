...
function loadHouseholdProducts() {
    fetch('get_products.php?category=household')
        ...
        .catch(error => {
            console.error("Household wrong：", error);
        });
}


function loadKitchenProducts() {
    fetch('get_products.php?category=kitchen')
        .then(response => response.json())
        .then(data => {
            renderProducts(data);
        })
        .catch(error => {
            console.error("Kitchen wrong：", error);
        });
}


function loadBathroomProducts() {
    fetch('get_products.php?category=bathroom')
        .then(response => response.json())
        .then(data => {
            renderProducts(data);
        })
        .catch(error => {
            console.error(" Bathroom wrong：", error);
        });
}


function loadElectricalEquipmentProducts() {
    fetch('get_products.php?category=electricalequipment')
        .then(response => response.json())
        .then(data => {
            renderProducts(data);
        })
        .catch(error => {
            console.error("Electrical Equipment wrong：", error);
        });
}
